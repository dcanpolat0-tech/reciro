...
const translations = {
  tr: {
    ...
    welcomeTitle: 'Yerel profilini seç',
    welcomeText: 'Reciro verilerini bu telefonda tutar. Yedek almak istersen Verilerim bölümünden dışa aktarabilirsin.',
    chooseAccount: 'Devam et',
    signedInWith: (provider) => `${provider} seçildi`,
    signInWithApple: 'Apple profiliyle devam et',
    signOut: 'Çıkış Yap',
    ...
    signInWithGoogle: 'Google profiliyle devam et',
  ...
  en: {
    ...
    welcomeTitle: 'Choose a local profile',
    welcomeText: 'Reciro keeps your data on this phone. You can export a backup from My data whenever you need it.',
    chooseAccount: 'Continue',
    signedInWith: (provider) => `${provider} selected`,
    signInWithApple: 'Continue with Apple profile',
    signOut: 'Sign out',
    ...
    signInWithGoogle: 'Continue with Google profile',
  ...
  fr: {
    ...
    welcomeTitle: 'Choisissez un profil local',
    welcomeText: 'Reciro garde vos donnees sur ce telephone. Vous pouvez exporter une sauvegarde depuis Mes donnees.',
    chooseAccount: 'Continuer',
    signedInWith: (provider) => `${provider} selectionne`,
    signInWithApple: 'Continuer avec le profil Apple',
    ...
    signInWithGoogle: 'Continuer avec le profil Google',
  ...
  de: {
    ...
    welcomeTitle: 'Lokales Profil auswaehlen',
    welcomeText: 'Reciro speichert deine Daten auf diesem Telefon. Du kannst unter Meine Daten ein Backup exportieren.',
    chooseAccount: 'Fortfahren',
    signedInWith: (provider) => `${provider} ausgewaehlt`,
    signInWithApple: 'Mit Apple-Profil fortfahren',
    signOut: 'Abmelden',
    ...
    signInWithGoogle: 'Mit Google-Profil fortfahren',
  ...
  es: {
    ...
    welcomeTitle: 'Elige un perfil local',
    welcomeText: 'Reciro guarda tus datos en este telefono. Puedes exportar una copia desde Mis datos.',
    chooseAccount: 'Continuar',
    signedInWith: (provider) => `${provider} seleccionado`,
    signInWithApple: 'Continuar con perfil Apple',
    ...
    signInWithGoogle: 'Continuar con perfil Google',
...
const featureTranslations = {
  en: {
    ...
    accountAndPremium: 'Account and local data',
  ...
  tr: {
    ...
    accountAndPremium: 'Hesap ve yerel veri',
...
featureTranslations.it = {
  ...
  accountAndPremium: 'Account e dati locali',
...
featureTranslations.pt = {
  ...
  accountAndPremium: 'Conta e dados locais',
...
Object.assign(featureTranslations.fr, {
  ...
  accountAndPremium: "Compte et donnees locales",
...
Object.assign(featureTranslations.de, {
  ...
  accountAndPremium: "Konto und lokale Daten",
...
Object.assign(featureTranslations.es, {
  ...
  accountAndPremium: "Cuenta y datos locales",
...
Object.assign(translations.it, {
  ...
  welcomeTitle: "Scegli un profilo locale",
  welcomeText: "Reciro conserva i tuoi dati su questo telefono. Puoi esportare un backup da I miei dati.",
  signInWithGoogle: "Continua con profilo Google",
...
Object.assign(translations.pt, {
  ...
  welcomeTitle: "Escolha um perfil local",
  welcomeText: "O Reciro guarda os seus dados neste telefone. Pode exportar um backup em Os meus dados.",
  signInWithGoogle: "Continuar com perfil Google",
...
Object.assign(translations.nl, {
  ...
  welcomeTitle: "Kies een lokaal profiel",
  welcomeText: "Reciro bewaart je gegevens op deze telefoon. Je kunt een back-up exporteren via Mijn gegevens.",
  signInWithGoogle: "Doorgaan met Google-profiel",
